  ...
  return (
    <div className="p-4 bg-gray-900 text-white min-h-screen">
      ...
      <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto">
        ...
        <button className="p-2 text-sky-400 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-sky-400 hover:text-gray-900 m-8" onClick={handleEditBook}>
          Save
        </button>
      </div>
    </div>
